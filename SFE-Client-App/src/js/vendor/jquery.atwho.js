 ...
 */
/*
*  Modified by guojun ! Please ask me if you want to upgrade the lib to newer version
* */
(function() {
    (function(factory) {
        ...
        Controller = (function() {
            ...
            Controller.prototype.insert = function(content, $li) {
                ...
                if ($inputor.is('textarea, input')) {
                    ...
                    //added by guojun, to avoid error when insert plain text
                    content_node = $(wrapped_content)[0] || this.app.document.createTextNode(wrapped_content);
